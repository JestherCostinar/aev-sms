...
>>>>>>> d05696c8a0c3a0ecc14796799fe99051f825c45f
...
function Closeticket(idNumber, type)
{
	...
	{
		$( "#closeincidentmodal" ).load("close_incident.php");
...
function editOic(fname, mname, lname, eadd, contact, id, bu, slevel){
...
function addInvolved2()
{
	...
	if((document.getElementById("witfname").value) && (document.getElementById("witlname").value) && (document.getElementById("selClassification").value))
	{
		...
		$("#tblinvolved tbody").append("<tr align='center'>" +
		  ...
		  "<td class='ilocators' style='display:none;'>" + document.getElementById("selinclocator").value + "</td>" +
	...
	{
		alert("Classification, First Name, and Llast Name required.");
	}
}
...
function saveCloseIncident()
{
	if(document.getElementById("txtIncidentDisposition").value)
	{
		...
		for (i4 = 0; i4 < iclassifications.length; i4++) {
			...
			document.getElementById("ilocatorsall").value += "*~" + iidtype[i4].innerHTML;
		}
...
{
	$("#tblAddIncMainClass tbody").append("<tr><td><input type='text' name='txtAddMainClass[]' style='text-align:center;' required><img src='images/delete.png' style='cursor:pointer;' onclick='this.parentNode.parentNode.parentNode.removeChild(this.parentNode.parentNode)'></td></tr>");
}
...
function initialLogs(type)
{
	if(type == 'Inc')
	{
		$("#tbodyIncidentTable").load("initial-logs.php?type="+type);
	}
	else if(type == 'Act')
	{
		$("#tbodyActivityTableTable").load("initial-logs.php?type="+type);
	}
	else if(type == 'Guard')
	{
