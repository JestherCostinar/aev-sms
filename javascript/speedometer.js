...
function buildOptionsAsJSON(canvas, scaleFactor, xOffset, yOffset, additionalOptions) {
  ...
  var options = {
    ...
    numLargeTicks: 10,                           // The number of large ticks on speedometer
    ...
    colorArcArray: [ { alpha: 1.0, color: "rgb(82, 240, 55)", startSpeed: -100, stopSpeed: 210},
                     { alpha: 1.0, color: "rgb(198, 111, 0)", startSpeed: 210, stopSpeed: 294},
                     { alpha: 1.0, color: "rgb(255, 0, 0)", startSpeed: 294, stopSpeed: 1000}]
  };
