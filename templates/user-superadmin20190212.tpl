...
<script src="javascript/OSLS.js"></script>
</head>
...
<div class="container">
			...
			<ul style="padding-left:10px; list-style-type:none;">
				...
				<li class="lists" onclick="toggleMenu('subEntries');">Entries</li>
					<ul id="subEntries" style="display:none; list-style-type:none;">
						<li class="lists" id="listact" onclick="toggleMe('Activities', 'listact');">Activities</li>
  ...
  <div id="multi" class="multi">
    	...
    	<table width="100%" align="center" >
        	<tr style="max-height:50%;">
            	<td width="50%" align="center" valign="middle">
                	<div id="divMeter" style="width: 500px; height: 250px;">
    ...
    <div id="addGuard" style="display:none;">
    	...
    	<!-- <form id="addguardform" name="addguardform" method="post" action="user-superadmin.php" enctype="multipart/form-data">
        	...
        	<tr valign="top">
            	...
            	<td width="40%" style="border-width:0px;">
                	...
                	<table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="txtgpreadd" name="txtgpreadd" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>Provincial Address:</td>
                            <td><input type="text" id="txtgproadd" name="txtgproadd" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="txtgbu" name="txtgbu" required="required">
                                	<option value=""></option>
                                    $budatalist
                                </select>
                            </td>
                	...
                	<table>
                        ...
                        <tr>
                        	<td>Date of Empolyment (Current Agency):</td>
                ...
                <td width="40%" valign="top" style="border-width:0px;">
                    ...
                    <table align="right">
                        <tr>
                        	<td>
                            	<input id="btneditguard" name="btneditguard" type="submit" class="redbutton" value="Update" style="display:none;" />
    ...
    <!-- <div id="secagencymodal2" style="display:none; padding-top:24px;" >
    <img src="images/x_mark_red.png" height="24px" style="cursor:pointer; position:absolute; right:10px; top:5px;" onclick="closeSecAgencySA();" />
    	<form id="secagencyform" name="secagencyform" method="post" action="user-superadmin.php">
        <table width="100%" align="center">
        <tr>
        <td width="50%" valign="top" align="center">
    	<fieldset>
	...
	<div id="ConComp" class="section">
		...
		<table id="tblCCShow" name="tblCCShow" width="90%" align="center" style="display:none; border-collapse:collapse;" border="1">
				...
				<td>
					<table align="center">
						<tr>
							...
							<td width="80%">								
								<select id="txtAddCCGoal2" name="txtAddCCGoal2" >
									...
									<option value="SG Requirement">SG Requirement</option>
									<option value="TOR Requirement">TOR Requirement</option>
									<option value="Governance">Governance</option>
								</select>
							</td>
						</tr>						
						...
						<tr>
							...
							<td width="80%"><input type="text" id="txtAddCCReference2" name="txtAddCCReference2"></td>
						</tr>
						<tr>
							<td width="20%">Source:</td>
							<td width="80%"><input type="text" id="txtAddCCSource2" name="txtAddCCSource2"></td>
						</tr>
						<tr>
							<td width="20%">Deduction:</td>
							<td width="80%"><input type="number" min="1" id="txtAddCCDeduction2" name="txtAddCCDeduction2"></td>
						</tr>
						<tr>
							<td width="20%">Group:</td>
							<td width="80%">
								<select id="txtAddCCGroup2" name="txtAddCCGroup2">
				...
				<td width="50%" style="padding-right:10px;">
					<table width="100%">
						<tr valign="top">
							...
							<td width="80%">
								<textarea id="txtAddCCStandard2" name="txtAddCCStandard2" style="resize:none; height:50px; width:100%;"></textarea>
							</td>
						</tr>
						<tr valign="top">
							<td width="20%">Details:</td>
							<td width="80%">
								<textarea id="txtAddCCDetails2" name="txtAddCCDetails2" style="resize:none; height:50px; width:100%;"></textarea>
							</td>
						</tr>
						<tr valign="top">
							<td width="20%">Hover Help:</td>
							<td width="80%">
			...
			<tr>
				<td colspan="100%" align="center"><button class="redbutton" onclick="addCCEntry3();">Add</button></td>
			</tr>
		</table>		
		<br>
		<br>
		...
		<table align="center">
			<tr>
				<td><button class="redbutton" id="btnSaveNewCC" name="btnSaveNewCC" style="display:none;" onclick="saveCCEntry3();">Save</button></td>
			</tr>
		</table>
	</div>
    ...
    <form id="formcpass" method="post" action="user-superadmin.php">
