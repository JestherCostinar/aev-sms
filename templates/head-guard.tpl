...
<script src="javascript/OSLS.js?v=$logdate"></script>
</head>
  ...
  <div class="multi">
	...
	<div id="Locators" class="section">		
		<table width="50%" align="center">
			<tr>
				<td align="right">                    			
					<img id="imgaddlocator" name="imgaddlocator" src="images/add_item.png" height="32px" style="cursor:pointer; vertical-align:middle;" > 
				</td>
			</tr>
		</table>
		<table width="90%" align="center" border="1" style="border-collapse:collapse">                    	
