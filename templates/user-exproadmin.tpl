...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <ul>
      ...
      <li class="lists" id="listdash" onclick="loadCharts3();toggleMe('Dashboard', 'listdash');">Dashboard</li>
  ...
  <div class="multi">
  	<div id="Dashboard" class="section">
    	<table width="95%" align="center">
        	<tr>
            	<td align="center" valign="middle" width="100%" colspan="100%">
    ...
    <div id="addGuard" style="display:none;">
    	...
    	<!-- <form id="addguardform" name="addguardform" method="post" action="user-admin.php" enctype="multipart/form-data">
    	<table width="95%" align="center" bgcolor="#ededed" border="1px">
        	<tr valign="top">
				<td class="guardphototd" style="border-width:0px; display:none;">
                	...
                	<table align="center">
                    	<tr>
                        	<td>
								<img id="guardpicbox" style="width:150px;" alt="No Photo"/>
							</td>
						</tr>
					</table>
            	...
            	<td width="40%" style="border-width:0px;">
                	...
                	<table>
                    	<tr>
                        	<td>Last Name:</td>
                            <td>
                            	<input type="text" id="txtguardid" name="txtguardid" required="required" readonly="readonly" style="display:none;" />
                            	<input type="text" id="txtglname" name="txtglname" required="required" class="addguards" />
                            </td>
                        </tr>
                        <tr>
                        	<td>First Name:</td>
                            <td><input type="text" id="txtgfname" name="txtgfname" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>Middle Name:</td>
                            <td><input type="text" id="txtgmname" name="txtgmname" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>Gender:</td>
                            <td>
                            	<select id="selggender" name="selggender" required class="addguards">
                                	<option value=""></option>
                        ...
                        <tr>
                        	<td>Date of Birth:</td>
                            <td><input type="date" id="txtgbdate" name="txtgbdate" required="required" class="addguards" /></td>
                            
                        </tr>
                        <tr>
                        	<td>Age:</td>
                            <td><input type="text" id="txtgage" name="txtgage" size="3" required="required" readonly="readonly" /></td>
                        </tr>
                        <tr>
                        	<td>Blood Type:</td>
                            <td>
                            	<select id="selgbloodtype" name="selgbloodtype" required class="addguards">
                                	<option value=""></option>
                        ...
                        <tr>
                        	<td>Civil Status:</td>
                            <td>
                            	<select id="selgcivstat" name="selgcivstat" required class="addguards">
                                	<option value=""></option>
                        ...
                        <tr>
                            ...
                            <td>
                            	<textarea id="txtgpreadd" name="txtgpreadd" required="required" class="addguards" rows="2" style="resize:none;"></textarea>
                        ...
                        <tr>
                            ...
                            <td>
                            	<textarea id="txtgproadd" name="txtgproadd" required="required" class="addguards" rows="2" style="resize:none;"></textarea>
                            	
                            </td>
                        </tr>
                        <tr>
                        	<td>Contact Number:</td>
                            <td><input type="text" id="txtgcontact" name="txtgcontact" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>Business Unit:</td>
                            <td>
                            	<input type="text" id="txtgbu" name="txtgbu" required="required" readonly="readonly" value="$headerBu" />
                            </td>
                        </tr>
                        <tr id="trguardstat">
                        	<td>Status:</td>
                            <td>
                            	<select id="selgstat" name="selgstat" class="addguards" >
                    ...
                    <br />
                    <fieldset style="border-width:thin">
                    <legend style="font-weight:bold">Employment History</legend>
                	<table>
                    	<tr>
                        	<td>Date posted in Aboitiz Group:</td>
                            <td><input type="date" id="txtgposted" name="txtgposted" required="required" class="addguards" /></td>
                        </tr>
                        
                        <tr>
                        	<td>Date of Employment (Current Agency):</td>
                            <td><input type="date" id="txtgempagency" name="txtgempagency" required="required" class="addguards" /></td>
                        </tr>
                        
                        <tr>
                        	<td>Guard Code:</td>
                            <td><input type="text" id="txtgcode" name="txtgcode" required="required" class="addguards" /></td>
                        </tr>
                    </table>
                    </fieldset>
                </td>
                <td width="40%" valign="top" style="border-width:0px;">
                	<fieldset style="border-width:thin">
                	...
                	<table>
                    	<tr>
                        	<td>Agency:</td>
                            <td>
                            	<select id="selgagency" name="selgagency" class="addguards">
                                	<option value=""></option>
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="txtgcategory" name="txtgcategory" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>Badge / SSS No.:</td>
                            <td><input type="text" id="txtgbadge" name="txtgbadge" required="required" class="addguards" /></td>
                        </tr>
						<tr>
                        	<td>NTC License No.:</td>
                            <td><input type="text" id="txtgntclicense" name="txtgntclicense" required="required" class="addguards" /></td>
                        </tr>
						<tr>
                        	<td>NTC License Issue Date:</td>
                            <td><input type="date" id="txtgntclicenseissue" name="txtgntclicenseissue" required="required" class="addguards" /></td>
                        </tr>
						<tr>
                        	<td>NTC License Expiry Date:</td>
                            <td><input type="date" id="txtgntclicenseexpiry" name="txtgntclicenseexpiry" required="required" class="addguards" min=$logdate/></td>
                        </tr>
                        <tr>
                        	<td>License No.:</td>
                            <td><input type="text" id="txtglicense" name="txtglicense" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>License Issue Date:</td>
                            <td><input type="date" id="txtglicenseissue" name="txtglicenseissue" required="required" class="addguards" /></td>
                        </tr>
                        <tr>
                        	<td>License Expiry Date:</td>
                            <td><input type="date" id="txtglicenseexpiry" name="txtglicenseexpiry" required="required" onchange="expiration();" class="addguards" min=$logdate /></td>
                        </tr>
                        <tr>
                        	<td>Remaining Years of Validity:</td>
                            <td><input type="text" id="txtgremaining" name="txtgremaining" readonly="readonly" /></td>
                        </tr>
                    </table>
                    </fieldset>
                    <br />
                    <fieldset style="border-width:thin">
                    <legend style="font-weight:bold">Remarks</legend>
                	<table width="100%" >
                        <tr>
                        ...
                        <tr>                        	
                            <td colspan="2" valign="top">Comment:<textarea id="gcomment" name="gcomment" style="resize:none; height:100px; width:100%;" class="addguards" ></textarea></td>
                        </tr>
                    </table>
                    </fieldset>
					<table id="tblupload">
                    ...
                    <table align="right">
                        <tr>
                        	<td>
                            	<input id="btneditguard" name="btneditguard" type="submit" class="redbutton" value="Edit" style="display:none;" />
                            	<input id="btnsaveguard" name="btnsaveguard" type="submit" class="redbutton" value="Save" />
                                <button id="gback" name="gback" class="redbutton">Cancel</button>                       		
                            </td>
                        </tr>
                    </table>
                                    ...
                                    <table width="100%"> 
                                      <tr>
                                        ...
                                        <td align="right" width="40%">
                                          ...
                                          <!-- <img id="btnsave" name="btnsave" src="images/save3.png" onclick="evaluateForm(this);" /> -->
      ...
      <table width="95%" align="center">
      	<tr>
        	...
        	<td align="right" width="65px">            	
                ...
                <!--<img src="images/refresh.png"  style="height:26px; cursor:pointer;" onclick="refreshPage('GuardMgt', 'user-admin');" />-->
    	...
    	<table width="95%" align="center">
      	<tr>
            ...
            <td width="30px" align="right">
                ...
                <!--<img src="images/refresh.png"  style="height:26px; cursor:pointer;" onclick="refreshPage('SecAgency', 'user-admin');" />-->
            </td>	          
        </tr>
      </table>
    ...
    <img src="images/x_mark_red.png" height="24px" style="cursor:pointer; position:absolute; right:10px; top:5px;" onclick="closeSecAgency();" />
    	...
    	<table align="center" width="95%">
        	...
        	<tr>
            	<td align="right">Name of Agency:</td>
                <td><input type="text" id="txtagencyname" name="txtagencyname" readonly="readonly" />
                </td>
            </tr>
            <tr>
            	<td align="right">Address:</td>
                <td><textarea id="txtagencyaddress" name="txtagencyaddress" style=" resize:none;" readonly="readonly"></textarea></td>
            </tr>
            <tr>
            	<td align="right">President/General Manager:</td>
                <td><input type="text" id="txtagencyoic" name="txtagencyoic" readonly="readonly" /></td>
            </tr>
            <tr>
            	<td align="right">Contact:</td>
                <td><input type="text" id="txtagencycontact" name="txtagencycontact" readonly="readonly" /></td>
            </tr>
         </table>
         </fieldset>
         <br />
         ...
         <table align="center" width="95%">                    
            <tr>
            	<td align="right">License Number:</td>
                <td><input type="text" id="txtagencylicensenum" name="txtagencylicensenum" readonly="readonly" /></td>
            </tr>
            <tr>
            	<td align="right">Issue Date:</td>
                <td><input type="date" id="txtagencylicenseissue" name="txtagencylicenseissue" readonly="readonly" /></td>
            </tr>
            <tr>
            	<td align="right">Expiration Date:</td>
                <td><input type="date" id="txtagencylicenseexpiry" name="txtagencylicenseexpiry" readonly="readonly" /></td>
            </tr>
         </table>
         </fieldset>
         <br />          
         <table id="tblagencybu" align="center" width="95%" border="1" style="border-collapse:collapse;">
             <thead>
             <tr class="whiteonblack">
                 <th>Business Unit(s)</th>
                 <th>Start Contract Date</th>
         ...
         <fieldset>
         <legend style="font-weight:bold">Company Profile</legend>           
         	<textarea id="txtagencyprofile" name="txtagencyprofile" style="width:100%; resize:none; height:75px;" readonly="readonly"></textarea>
         </fieldset>
         <br />
          ...
          <table align="center" width="95%">
            <tr>
            	<td align="right">Status of Contract:</td>
                <td>
                	<select id="selcontractstat" name="selcontractstat" disabled="disabled">
                    	<option value=""></option>
                        <option value="Active">Active</option>
                        <option value="Inactive">Inactive</option>
                    </select>
	...
	<div id="ConComp" class="section">
		...
		<table align="center" id="tblConCompHeader" style="padding-left:24px;" width="100%">
			<tr>
				...
				<td align="left" colspan="100%"><input id="txtCCAdminYear" name="txtCCAdminYear" type="number" min="2017" value="2018"><img src="images/Search-icon.png" height="24px" id="btnShowCCScores" name="btnShowCCScores" title="Search CC" style="cursor:pointer; vertical-align:middle;" onclick="searchScores();"></td>
			</tr>
			<tr>
    ...
    <form id="frmEntries" name="frmEntries" action="user-admin.php" method="post">
