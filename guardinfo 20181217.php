...
$divcontent = '<form id="addguardform" name="addguardform" method="post" action="user-admin.php" enctype="multipart/form-data">
						...
						<tr valign="top">
							<td class="guardphototd" style="border-width:0px; width:200px;">					
								...
								<table align="center" width="100%" border="1" style="border-collapse:collapse;">
									...
									<tr>
										<td align="center"><label style="font-weight:bold; cursor:pointer;" onclick="toggleTabs(\'guardemploymenttab\', \'guardmaintabs\');">Employment History</label></td>
									</tr>
								</table>
								<br>
								<table align="center">
							...
							<td style="border-width:0px;">
								<fieldset class="guardmaintabs" id="guardpersonaltab" style="border-width:thin">					
									...
									<table>
										...
										<tr>
											<td>Middle Name:</td>
											<td><input type="text" id="txtgmname" name="txtgmname" required="required" class="addguards" value="'.$guardmname.'" '.$viewonly.' /></td>
										</tr>
										<tr>
											<td>Gender:</td>
											<td>
												<select id="selggender" name="selggender" required class="addguards" '.$disable.'>
													<option value="'.$guardgender.'">'.$guardgender.'</option>
										...
										<tr>
											<td>Date of Birth:</td>
											<td><input type="date" id="txtgbdate" name="txtgbdate" required="required" class="addguards" value="'.$guardbirthdate.'" '.$viewonly.' onchange="getGuardAge();"/></td>									
										</tr>
										<tr>
											<td>Age:</td>
											<td><input type="text" id="txtgage" name="txtgage" size="3" required="required" readonly="readonly" value="'.$guardage.'" /></td>
										</tr>
										<tr>
											<td>Blood Type:</td>
											<td>
												<select id="selgbloodtype" name="selgbloodtype" required class="addguards" '.$disable.'>
													<option value="'.$guardbloodtype.'">'.$guardbloodtype.'</option>
										...
										<tr>
											<td>Civil Status:</td>
											<td>
												<select id="selgcivstat" name="selgcivstat" required class="addguards" '.$disable.'>
													<option value="'.$guardcivilstatus.'">'.$guardcivilstatus.'</option>
										...
										<tr>
											...
											<td>
												<textarea id="txtgpreadd" name="txtgpreadd" required="required" class="addguards" rows="2" style="resize:none; width:200px;" '.$viewonly.'>'.$guardpresentaddress.'</textarea>
											</td>
										</tr>
										<tr>
											<td>Provincial Address:</td>
											<td>
												<textarea id="txtgproadd" name="txtgproadd" required="required" class="addguards" rows="2" style="resize:none; width:200px;" '.$viewonly.'>'.$guardprovincialaddress.'</textarea>
											</td>
										</tr>
										<tr>
											<td>Contact Number:</td>
											<td><input type="text" id="txtgcontact" name="txtgcontact" required="required" class="addguards" '.$viewonly.' value="'.$guardcontact.'" /></td>
										</tr>
										<tr>
											<td>Business Unit:</td>
											<td>												
								...
								<fieldset class="guardmaintabs" id="guardemploymenttab" style="border-width:thin; display:none;">
									...
									<table>
										...
										<tr>
											...
											<td><input type="date" id="txtgempagency" name="txtgempagency" required="required" class="addguards" value="'.$guardagencyemployment.'" '.$viewonly.' /></td>
										</tr>										
									</table>
								</fieldset>
								<fieldset class="guardmaintabs" id="guardsecuritytab" style="border-width:thin; display:none;">
									...
									<table>
										...
										<tr> 
											...
											<td>
												<select id="txtgcategory" name="txtgcategory" required="required" class="addguards" '.$viewonly.' >
													<option value="'.$guardcategory.'">'.$guardcategory.'</option>
										...
										*	
										...
										<tr>
											<td ><label>Badge / SSS No.:</label></td>
											<td><input type="text" id="txtgbadge" name="txtgbadge" required="required" class="addguards" value="'.$guardbadgenumber.'" '.$viewonly.' /></td>
										</tr>
										<tr>
											<td colspan="100%">
												<table>
