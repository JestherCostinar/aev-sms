...
if($cctestres)
{
	...
	elseif($cctestres['total_score'] == 19110916)
	{
...
$ccmaintable .=  "<form id='frmCCAdmin' name='frmCCAdmin' method='post' action='user-superadmin.php'>" .
