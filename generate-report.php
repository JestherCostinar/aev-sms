...
$reporttable ="<div id=\"printReport\">
		...
		<table align=\"center\" width=\"100%\" border=\"1\" style=\"border-collapse:collapse;\">
			<tr>
				...
				<td rowspan=\"3\" align=\"center\" width=\"47%\">
					<label style=\"font-size:18px; font-weight:bold;\">INCIDENT REPORT</label>					
				</td>
				<td width=\"33%\">
		...
		<table align=\"center\" width=\"100%\" border=\"1\" style=\"border-collapse:collapse;\">
			<tr>
				<td class=\"blackongray reportalign\">
					Business Unit
				</td>
			...
			<tr>
				...
				<td colspan=\"2\" class=\"reportalign\" style=\"border-right:0px\">";
				if($resIncident['name'])
				{
...
$reporttable .="</td>
			...
			<tr>
				...
				<td class=\"reportalign\" colspan=\"2\" style=\"border-right:0px\">
			...
			<tr>
				...
				<td class=\"reportalign\" colspan=\"100%\">
...
$reporttable .=
		"<div id=\"divReportDisposition\">
			...
			<table align=\"center\" width=\"100%\" border=\"1\" style=\"border-collapse:collapse;\">
				...
				<tr>
					<td align=\"center\">".$resTicket['dateclosed']."</td>
					<td align=\"center\">".$resTicket['disposition']."</td>
				</tr>
			</table>
		<br>
		</div>";
...
$reporttable .=
		...
		<table align=\"center\" width=\"100%\" border=\"1\" style=\"border-collapse:collapse;\">
			...
			<tr height=\"50\" align=\"center\" valign=\"bottom\" >
				<td colspan=\"2\" >".$resGuard['lname'].", ".$resGuard['fname']." ".$resGuard['mname']."</td>
				<td colspan=\"2\" id=\"tdSIC\"><input id=\"txtSIC\" class=\"txtborderless rDates\" type=\"text\" style=\"text-align:center;\" /></td>
				<td colspan=\"2\" id=\"tdSecMgr\"><input id=\"txtSecMgr\" class=\"txtborderless rDates\" type=\"text\" style=\"text-align:center;\" /></td>
			</tr>
			<tr>
				<td width=\"10%\" class=\"blackongray \">Date</td>
				<td width=\"20%\"></td>
				<td width=\"10%\" class=\"blackongray \">Date</td>
				<td width=\"20%\"></td>
				<td width=\"10%\" class=\"blackongray \">Date</td>
		...
		<table align=\"center\" width=\"100%\">
    	<tr align=\"center\">
        	<td><button class=\"redbutton\" style=\"cursor:pointer;\" onclick=\"PrintReport();\">Print</button>  <button class=\"redbutton\" style=\"cursor:pointer;\" onclick=\"CloseReport();\">Close</button></td>
        </tr>
		<tr align=\"center\">
			<td colspan=\"100%\"><label id=\"reportlabel\" style=\"text-decoration:underline; color:#00F; cursor:pointer;\" onclick=\"toggleAttachments();\">View Attachment(s)</label></td>
		</tr>
    </table>";
